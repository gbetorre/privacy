...
public class ActivityBean extends CodeBean {
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e questo attributo non &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
