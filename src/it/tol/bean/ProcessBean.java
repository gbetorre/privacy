...
public class ProcessBean extends CodeBean {
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e dataInizio non &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e dataFine non &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e idDipart non         &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e dipart non         &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e rilevazione non &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
     ...
     * @throws it.tol.exception.AttributoNonValorizzatoException  eccezione che viene sollevata se questo oggetto viene usato e statoprocesso non         &egrave; stato valorizzato (&egrave; un dato obbligatorio)
     */
